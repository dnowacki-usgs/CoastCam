...
RAWIMAGES = False
if RAWIMAGES:
    fildir = "/Volumes/Argus/tla/RawImages/jpg1741548541513/"
    product = ""
else:
    fildir = "/Volumes/Argus/tla/"
    product = "snap"
fildir = "d:" + fildir

extrinsic_cal_files = [
    "/Users/dnowacki/projects/ak/py/tla_extrinsic_c1.json",
    "/Users/dnowacki/projects/ak/py/tla_extrinsic_c2.json",
]
intrinsic_cal_files = [
    "/Users/dnowacki/projects/ak/py/tla_intrinsic_c1.json",
    "/Users/dnowacki/projects/ak/py/tla_intrinsic_c2.json",
]

local_origin = {"x": 436156, "y": 7238543, "angd": 142}
...
if RAWIMAGES:
    ...
    ts1 = [
        ...
        for x in glob.glob(fildir + "products/1*Jan*c1." + product + ".jpg")
    ]
    ts2 = [
        os.path.basename(x).split(".")[0]
        for x in glob.glob(fildir + "products/1*Jan*c2." + product + ".jpg")
    ]
