...
intrinsic_cal_files = [
    "/Users/dnowacki/projects/ak/py/brw_intrinsic_c1.json",
...
def lazyrun(metadata, intrinsics_list, extrinsics_list, local_origin, t, z):
    ...
    if camera == "cx":
        ...
        c2bad = False
        image_files = [
            fildir + "products/" + t + ".c1." + product + ".jpg",
...
ts = [
    x for x in ts if int(x) >= 1630294200
]  # only good images from when the camera was aimed correctly
